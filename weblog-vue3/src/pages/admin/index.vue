    ...
    <div class="w-full">
        ...
        <div class="grid grid-cols-4 gap-7">
            ...
            <div class="col-span-4 md:col-span-1">
                <!-- 卡片 -->
                <div
                    class="flex items-center h-full w-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-[#1e1e1e] dark:border-gray-700">
        ...
        <div class="col-span-4 md:col-span-2">
            <!-- 卡片 -->
            <div class="w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-[#1e1e1e] dark:border-gray-700">
                <h2 class="flex items-center mb-2 font-bold text-[#555] uppercase dark:text-[#e8e8e8]">
                    <!-- 日历图标 -->
