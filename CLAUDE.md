...
动态实现文章标题、分类名、自动出现在浏览器标签栏。

https://abswitchj.com/category/list 标题：Category | abSwitchJ

https://abswitchj.com/about 标题：About | abSwitchJ

http://127.0.0.1:5173/category/分类名 标题：分类名

https://www.abswitchj.com/article/slug.html 标题：文章标题

https://abswitchj.com 标题：abSwitchJ
...
必要时可以考虑创建数据库或者重构t_blog_settings表，但是需要确保逻辑正确。还需要确保其他页面不改动，前后端访问正常。
